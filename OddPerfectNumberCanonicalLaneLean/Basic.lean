/-!
# odd-perfect-number-canonical-lane Lean migration boundary
...
`OddPerfectNumberCanonicalLaneLean/SourcePackage.lean`.
...
def sourceRepository : String := "odd-perfect-number-canonical-lane"
def sourceUrl : String := "https://github.com/HautevilleHouse/odd-perfect-number-canonical-lane"
def sourceDescription : String := "Canonical-lane closure package for the odd perfect number problem: admissible-class formulation, projection gates, local-to-global bridge, and carried remainder."
def sourceClassification : String := "abstract_math_theorem_repo"
def sourceTopics : List String := ["mathematical-proof", "number-theory", "perfect-numbers", "reproducibility", "arithmetic-number-theory", "divisor-sums", "odd-perfect-number", "canonical-lane", "local-to-global", "manifold-constrained"]
