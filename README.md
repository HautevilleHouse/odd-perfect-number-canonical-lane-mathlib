# Odd Perfect Number — Canonical Lane Mathlib
...
```bash
git clone https://github.com/HautevilleHouse/odd-perfect-number-canonical-lane-mathlib.git
cd odd-perfect-number-canonical-lane-mathlib
lake exe
lake build
```
